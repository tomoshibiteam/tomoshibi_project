...
export const defaultCharacterCapabilities = {
  canSuggestFood: true,
  canSuggestCafe: true,
...
export function createDefaultCharacter(characterId: string, now: string): Character {
  return {
    id: characterId,
    name: "トモシビ",
    ...
    capabilities: defaultCharacterCapabilities,
