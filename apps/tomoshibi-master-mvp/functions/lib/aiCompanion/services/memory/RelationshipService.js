...
class RelationshipService {
    recordSessionStarted(relationship, now) {
        return {
            ...relationship,
    ...
    applyFeedbackSignal(relationship, event, now) {
    ...
    recordJourneyCompleted(relationship, journeyMemory, now) {
...
function buildSharedMemorySummary(currentSummary, journeyMemory) {
